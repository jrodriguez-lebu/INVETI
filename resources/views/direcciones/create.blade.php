...
<div class="max-w-lg">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-800">Crear Dirección</h2>
            <p class="text-xs text-gray-500 mt-0.5">Las direcciones agrupan los departamentos de la municipalidad.</p>
        </div>
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="descripcion" rows="3"
                              placeholder="Descripción opcional de la dirección..."
