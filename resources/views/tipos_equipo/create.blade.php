...
<div class="max-w-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200" x-data="{ icono: '{{ old('icono', '💾') }}' }">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-800">Nuevo Tipo de Equipo</h2>
        </div>
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}" required
                           placeholder="Ej: Tablet, Servidor, Escáner..."
